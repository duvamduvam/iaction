...
import { SHORTCUT_GROUPS } from "./raccourcisClavier";
import { ReseauSection } from "./ReseauSection";
 ...
 */
type ConfigTabId = "projects" | "providers" | "models" | "voice" | "apps" | "reseau" | "shortcuts";
  ...
  return (
    <div className="page providers-page">
      ...
      <div className={configPanelClass(configTab === "reseau")}>
        <ReseauSection active={configTab === "reseau"} />
      </div>
