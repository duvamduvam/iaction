...
> Nom de travail. Plan produit complet : [docs/plan.md](docs/plan.md).
...
- **sidecar/** — process Node : moteurs IA (Claude Agent SDK + moteur neutre OpenAI-compatible, à venir).
...
**Lot 0 — Squelette** : app Tauri + React + sidecar Node supervisé, flux streamé bout en bout,
thème néon. Feuille de route complète en fin de [docs/plan.md](docs/plan.md).
